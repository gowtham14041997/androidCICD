...
public class Core {
    private static final Logger LOGGER = LogManager.getLogger(com.rupeek.web.service.Core.class);
    ...
    public void createLoan(long time,String url,String phone,boolean loanType) throws IOException {
